...
a = re.sub(r'setting\(body,\s*"Sürüm",\s*"v0\.8\.\d+"\)', 'setting(body,"Sürüm","v0.8.7")', a)
...
m = re.sub(r'ELAK-Okulum/0\.8\.\d+ tr-TR', 'ELAK-Okulum/0.8.7 tr-TR', m)
main.write_text(m, encoding="utf-8")

r = api.read_text(encoding="utf-8")
r = re.sub(r'ELAK-Okulum/0\.8\.\d+ Android', 'ELAK-Okulum/0.8.7 Android', r)
api.write_text(r, encoding="utf-8")

print("v0.8.7 WhatsApp/version patch applied")
