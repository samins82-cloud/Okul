...
for p in files:
    ...
    s = re.sub(r'ELAK-Okulum/0\.\d+\.\d+', 'ELAK-Okulum/0.9.1', s)
    s = re.sub(r'v0\.\d+\.\d+', 'v0.9.1', s)
    s = s.replace('ELAK Okulum 0.9.0', 'ELAK Okulum 0.9.1')
    p.write_text(s, encoding="utf-8")
print("ELAK Okulum 0.9.1 version alignment applied")
